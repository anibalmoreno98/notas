...
public class FormNuevaController {
    ...
    public void setMainController(CarpetaFxController controller) {
    ...
    public void guardarNota() {
        try {
            ...
            n.setCarpeta(mainController != null ? mainController.getCarpetaActual() : "General");
